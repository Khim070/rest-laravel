                ...
                <div class="col-span-2">
                    <div class="card ">
                        <div class="card-body ">
                            <div class=" ">
                                <div class=" ">
                                    <h4 class="text-gray-500 text-lg font-semibold mb-4">Comments</h4>
                                    <textarea class=" w-full h-60 px-4 text-gray-500 block border-gray-200 rounded-sm text-md focus:border-blue-600 focus:ring-0 "/>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body ">
                            ...
                            <div class="flex items-center justify-between gap-12">
                                <div class="flex items-center justify-center w-full">
                                    <label for="dropzone-file" class="flex flex-col items-center justify-center w-full h-60 border-2 border-gray-300 !border-dashed rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100">
                ...
                <div class="col-span-1">
                    <div class="card ">
                        <div class="card-body !py-2">
                            <div class=" !mb-5 ">
                                <div class="mb-3 ">
                                    <h4 class="text-gray-500 text-lg font-semibold mb-2">Rating</h4>
                                    <input type="number" min="0" max="5" step="0.01" class="py-3 w-full px-4 text-gray-500 block border-gray-200 rounded-sm text-md focus:border-blue-600 focus:ring-0" />
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class=" !mb-5 ">
                                <div class="mb-3 ">
                                    ...
                                    <select class="py-2.5 w-full px-4 text-gray-500 block border-gray-200 rounded-sm text-md focus:border-blue-600 focus:ring-0">
                                        ...
                                        <option value="">Apply Watch</option>
...
export default ReviewBodyField