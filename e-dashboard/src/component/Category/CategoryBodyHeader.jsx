        ...
        <header class=" bg-white shadow-md rounded-md w-full text-sm py-4 px-6">
            <nav class=" w-ful flex items-center justify-between" aria-label="Global">
                <ul class="icon-nav flex items-center gap-4">
                    ...
                    <li class="relative">
                        <div class=" ">
                            <Link to="/category" class="mr-4 btn-outline-danger font-medium text-[15px] w-full hover:!bg-red-700 hover:!outline-red-700 hover:text-white">Back</Link>
...
export default CategoryBodyHeader